...
| --- | --- |
| node01 |  Nodemanager |
| node02 |  ResourceManager、Nodemanager |
| node03 |  Nodemanager |
...
```bash
vim /bigdata/server/hadoop/etc/hadoop/mapred-env.sh
```
...
```bash
vim /bigdata/server/hadoop/etc/hadoop/mapred-site.xml
```
...
```bash
vim /bigdata/server/hadoop/etc/hadoop/yarn-env.sh
```
...
```bash
vim /bigdata/server/hadoop/etc/hadoop/yarn-site.xml
```
...
```bash
xsync /bigdata/server/hadoop/etc/hadoop
```
